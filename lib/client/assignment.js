const QUESTIONS = [
  "matriculationNumber", "name", "nationality", "age", 
  "priorEducation","topicInterest", "priorWebdev", "favCSExp", "anythingElse"
];
...
const saveAnswers = async () => {
  ...
  if (!json.success) {
    console.error("Something went wrong while saving answers. You may have to check your terminal window for a Node.js error.");
    return;
  }
  console.log("You're all set! You should now have an answers.json file in your assignment directory.");
  console.log("Please push your code to Github to complete the assignment.");
};
